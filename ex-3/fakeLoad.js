...
function loadPageAfterDelay(loadTime, url){
  ...
  // document.getElementByClass("loading").style.display = 'block';

  document.getElementsByClassName("load-throbber")[0].style.display = 'inline-block'; /* CHANGED FROM id TO class SO ELEMENT CAN BE REUSED */
